/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fdff561b4c92163cb7e144d529b5a428)
...
interface __BaseEnv_Env {
	...
	PARENT_RESEARCH_AKID: string;
	PARENT_RESEARCH_SECRET: string;
	PARENT_PRODUCTION_AKID: string;
	PARENT_PRODUCTION_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCOUNT_ID" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "PARENT_RESEARCH_AKID" | "PARENT_RESEARCH_SECRET" | "PARENT_PRODUCTION_AKID" | "PARENT_PRODUCTION_SECRET">> {}
}
